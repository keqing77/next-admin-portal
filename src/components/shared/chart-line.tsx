...
const yearlyData = [
  { date: "2023-01-01", desktop: 65860, mobile: 43120 },
  { date: "2024-01-01", desktop: 85973, mobile: 49990 },
  { date: "2025-01-01", desktop: 92209, mobile: 55130 },
];
...
export function ChartLine() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          Line Chart - {timeFrame.charAt(0).toUpperCase() + timeFrame.slice(1)}{" "}
          Visitors
        </CardTitle>
